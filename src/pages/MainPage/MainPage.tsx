...
const userSubscribeData = [
  {
    linkImg: "./img/profile/profile-img-1.jpeg",
    mainText:'N E W',
    secondaryText:'Развитие'
  },
  {
    linkImg: "./img/profile/profile-img-2.jpeg",
    mainText: "Aesthetics",
    secondaryText: 'Стиль'
  },
  {
    linkImg:"./img/profile/profile-img-3.jpeg" ,
    mainText: 'дом твоей эстетики',
    secondaryText:'Творчество'
  },
  {
    linkImg:"./img/profile/profile-img-4.jpeg",
    mainText:'wailet',
    secondaryText:'Искусство'
  },
  {
    linkImg:"./img/profile/profile-img-5.jpeg",
    mainText:'A W E S O M E',
    secondaryText:'Стиль'
  },
  {
    linkImg:"./img/profile/profile-img-6.jpeg",
    mainText:'minimalism',
    secondaryText:'Фотография'
  },
  {
    linkImg:"./img/profile/profile-img-7.jpeg",
    mainText:'Словарный запас',
    secondaryText:'Литература'
  },
  {
    linkImg:"./img/profile/profile-img-8.jpeg",
    mainText:'Look',
    secondaryText:'Мода'
  }
]
...
{
  linkImg:"./img/users/aleksandr-maykov.jpeg",
        ...
        <div className="MainPage">
          ...
          <NavBar/>
            <div className="List">
              <div className="List__title">
                <Heading headerText={"Подписки"} headerType={"h1"}/>
                <span className="count">123</span>
              </div>
            {
              userSubscribeData.map((elem)=> (
                <UserElem linkImg={elem.linkImg} mainText={elem.mainText} secondaryText={elem.secondaryText} />
              ))
            }
          ...
          <aside className="RightSide">
            <div className="List">
              ...
              {
                userFriendsData.map((i) => (
                  <UserElem  linkImg={i.linkImg} mainText={i.mainText} secondaryText={i.secondaryText}/>
                ))
              }
            </div>
            <div className="MusicBlock">
              <div className="MusicBlock__title">
                <Heading headerText={"Вы недавно слушали"} headerType={"h2"}/>
                <span>123</span>
              </div>
              {
  userMusicData.map((i) => (
